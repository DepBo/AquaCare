...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // Nếu thành công, browser sẽ redirect – không cần làm gì thêm
  }
      ...
      >
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          <button
            ...
            onMouseEnter={e => { if (!googleLoading) { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.2)'; e.currentTarget.style.background = 'rgba(255,255,255,0.07)'; e.currentTarget.style.transform = 'translateY(-1px)' } }}
          ...
          >
            {googleLoading ? (
              <><span style={{ width: 14, height: 14, border: '2px solid rgba(255,255,255,0.3)', borderTopColor: '#fff', borderRadius: '50%', animation: 'spin 0.7s linear infinite', display: 'inline-block' }} /> Đang chuyển hướng...</>
            ) : (
              <>
