        ...
        <div style={{ padding: '16px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(26,45,74,0.4)', background: 'rgba(10,20,38,0.7)', backdropFilter: 'blur(8px)', position: 'sticky', top: 0, zIndex: 10 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>Thiết bị:</span>
              <select
                value={activeDevice}
                onChange={e => setActiveDevice(e.target.value)}
                style={{
                  background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)',
                  color: '#00A896', padding: '6px 12px', borderRadius: 8, fontSize: 12, outline: 'none', cursor: 'pointer', fontFamily: F, fontWeight: 600
                }}
              >
                {DEVICES.map(d => <option key={d.id} value={d.id} style={{ background: '#0d2235', color: '#fff' }}>{d.name}</option>)}
              </select>
            </div>
            ...
            <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#00A896', boxShadow: '0 0 8px #00A896', animation: 'pulse 2s ease-in-out infinite' }} />
            <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>Live</span>
